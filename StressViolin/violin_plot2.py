...
# Example usage
xlsx_file = 'combined_dataset-selected-56.xlsx'
selected_attributes = ['ACTIVITY_OF_VASOMOTOR_CENTERS', 'HEART_RATE', 'INTEGRAL_INDICATOR_BY_IARS', 'MYOCARDIUM', 'PSYCHO_EMOTIONAL_STATE']
class_A = 9
class_B = 10
class_A_name = 'High Stress'
class_B_name = 'Prewar Cadets'
color_A = '#FF0000'
color_B = "#0ecaeb"
