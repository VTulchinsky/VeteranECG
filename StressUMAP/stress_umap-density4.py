...
# Use only the first two columns of em
em_slice = embedding[:, :2]

# Convert to DataFrame
em_df = pd.DataFrame(em_slice, columns=['UMAP_1', 'UMAP_2'])

# Concatenate horizontally
combined_df = pd.concat([df, em_df], axis=1)

# Save to Excel file
combined_df.to_excel('umap_' + file_path, index=False)
