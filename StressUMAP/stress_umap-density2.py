...
def plot_density_scatter(embedding, data, color_map, cmap_map, title=None):
    ...
    for risk_value, color in color_map.items():
        indices = data["STRESS"].astype(int) == risk_value
...
plot_density_scatter(embedding, df, color_map, cmap_map,
                        title="Stress Density by Types")
