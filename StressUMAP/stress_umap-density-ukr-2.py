...
def plot_density_scatter(embedding, data, color_map, cmap_map, title=None):
    ...
    legend_elements = [
        Line2D([0], [0], marker='o', color='w', label=risk_descriptions[10],
               markerfacecolor=color_map[10], markersize=8, markeredgecolor="k"),
    ...
    plt.legend(handles=legend_elements, fontsize=15, loc="upper right", frameon=True, fancybox=True)
...
plot_density_scatter(embedding, dfy, color_map, cmap_map,
                        title="ECG Clusters of Military Stress Types")
