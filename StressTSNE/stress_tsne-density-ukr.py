...
def plot_density_scatter(embedding, data, color_map, cmap_map, title=None):
    ...
    # Легенда
    legend_elements = [
        Line2D([0], [0], marker='o', color='w', label='Prewar (Bocharov, Sofia)',
               markerfacecolor=color_map[1], markersize=10, markeredgecolor="k"),
        Line2D([0], [0], marker='o', color='w', label='Postwar (Khmilnyk)',
               markerfacecolor=color_map[2], markersize=10, markeredgecolor="k"),
        Line2D([0], [0], marker='o', color='w', label='Wound (Hospital)',
               markerfacecolor=color_map[3], markersize=10, markeredgecolor="k"),
        Line2D([0], [0], marker='o', color='w', label='Frontline (Bakhmut)',
               markerfacecolor=color_map[4], markersize=10, markeredgecolor="k"),
        Line2D([0], [0], marker='o', color='w', label='Population (UkrNorm)',
...
# Load Excel file
file_path = "combined_dataset-selected-ukr.xlsx"
...
plot_density_scatter(embedding, dfy, color_map, cmap_map,
                        title="Classified Stress Density")
