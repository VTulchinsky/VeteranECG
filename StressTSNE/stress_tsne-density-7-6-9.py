...
def plot_density_scatter(embedding, data, color_map, cmap_map, title=None):
    ...
    legend_elements = [
        Line2D([0], [0], marker='o', color='w', label=risk_descriptions[7],
               markerfacecolor=color_map[7], markersize=10, markeredgecolor="k"),
        Line2D([0], [0], marker='o', color='w', label=risk_descriptions[6],
               markerfacecolor=color_map[6], markersize=10, markeredgecolor="k"),
        Line2D([0], [0], marker='o', color='w', label=risk_descriptions[9],
               markerfacecolor=color_map[9], markersize=10, markeredgecolor="k"),
...
# Load Excel file
file_path = "combined_dataset-selected-56.xlsx"
...
plot_density_scatter(embedding, dfy, color_map, cmap_map,
                        title="Розподіл військових, що перебувають на лікуванні чи реабіліації")
